...
namespace WebDel3Part2.Migrations
{
    ...
    [Migration("20181128233743_admins")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDel3Part2.Models.UserWrapper", b =>
                {
                    b.Property<int>("AdminId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UserWrapper");
                });

            modelBuilder.Entity("WebDel3Part2.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("WebDel3Part2.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("WebDel3Part2.Models.ESImage", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    b.HasOne("WebDel3Part2.Models.UserWrapper")
                        .WithMany("RequestingAdminUsers")
            ...
            modelBuilder.Entity("WebDel3Part2.Models.Component", b =>
                {
                    b.HasOne("WebDel3Part2.Models.ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("WebDel3Part2.Models.ComponentType", b =>
                {
                    b.HasOne("WebDel3Part2.Models.ESImage", "Image")
                        .WithMany()
